...
public class Specimen_Auto extends OpMode {
    ...
    private final Pose PushPt1 = new Pose(29, 40, Math.toRadians(0));//weird path before pushing

    private final Pose PushPt2 = new Pose(62, 40, Math.toRadians(0));

    private final Pose PushPt3 = new Pose(62, 35, Math.toRadians(0));

    private final Pose PushPt4 = new Pose(30, 35, Math.toRadians(0));

    private final Pose PushPt4TEST = new Pose(62, 35, Math.toRadians(0));
    private final Pose PushPt5 = new Pose(62, 30, Math.toRadians(0));


    private final Pose PushPt6 = new Pose(30, 30, Math.toRadians(0));

    private final Pose PushPt6TEST = new Pose(62, 30, Math.toRadians(0));

    private final Pose PushPt7 = new Pose(62, 25, Math.toRadians(0));


    private final Pose PushPt8 = new Pose(30, 25, Math.toRadians(0));

    private final Pose PushPt9 = new Pose(31, 25, Math.toRadians(0));

    private final Pose PushPt10 = new Pose(15, 25, Math.toRadians(0));
